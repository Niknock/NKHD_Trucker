...
Citizen.CreateThread( function()
    PerformHttpRequest("https://raw.githubusercontent.com/Niknock/NKHD_Trucker/main/version", checkVersion, "GET")
end)